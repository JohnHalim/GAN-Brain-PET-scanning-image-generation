# -*- coding: utf-8 -*-
"""Image_to_image_translation_(GAN)_(3) (3).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1S5dIy63eokQvcaEcjFtJwvwEoe9GhN1Q
"""
...
for i in range(training_images.shape[0]):
    ssim_noise.append( ssim(training_images[i,:,:,0], x_fake.numpy()[Random_Image,:,:,0],data_range=np.max(x_fake.numpy()[whichfake,:,:,0]) - np.min(x_fake.numpy()[whichfake,:,:,0])))
